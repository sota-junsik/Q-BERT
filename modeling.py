...
def insert_quant_act_modules(model):
    ...
    for name, layer in model._modules.items():
        ...
        if name == 'output' or name == 'dropout':
            continue
...
class BertPreTrainedModel_Quant(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        # Load config
        if config_dir != None and config_dir != "":
    ...
    def __init__(self, config):
        ...
        if 'layer_bits' in config_dict:
            ...
            for module_path, module in self.encoder.named_modules():
                ...
                if classname == "QuantLinear" and module_path in layer_bits:
            ...
            if config_dict.get('emb_bits', None):
                ...
                for module_path, module in self.embeddings.named_modules():
                    classname = module.__class__.__name__
                    if classname == "QuantEmbedding" and module_path in emb_bits:
